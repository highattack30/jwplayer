define([
    ...
    describe('scriptloader', function () {
        ...
        it.skip('scriptloader.getStatus', function () {
            // check status new
        ...
        it.skip('scriptloader with style', function () {
        ...
        it.skip('scriptloader with script', function () {
        ...
        it.skip('scriptloader load same script', function () {
        ...
        it.skip('scriptloader with actual path', function () {
